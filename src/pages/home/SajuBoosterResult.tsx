...
import _vector26 from "../../assets/images/Vector 26.svg";
import _vector6 from "../../assets/images/Vector 6.svg";
  ...
  return (
    <div className={styles.root}>
      ...
      <nav className={styles.tabNav}>
        ...
        <button className={styles.tab} onClick={() => onTabClick?.("운의 흐름")}>운의 흐름</button>
      </nav>
