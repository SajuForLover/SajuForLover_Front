...
import { loadPhotos } from "@/pages/yoon-sea-photo-shoot/photoShootData";
import styles from "./YoonSeaPhotoShootResultPage.module.css";

export function YoonSeaPhotoShootResultPage() {
  ...
  if (completedPhotos.length < 4) {
    return <Navigate to="/yoon-sea-photo-shoot" replace />;
  }
