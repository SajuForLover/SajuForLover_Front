...
import { loadPhotos } from "@/pages/jaehyun-photo-shoot/photoShootData";
import styles from "../yoon-sea-photo-shoot-result/YoonSeaPhotoShootResultPage.module.css";

export function JaehyunPhotoShootResultPage() {
  ...
  if (completedPhotos.length < 4) {
    return <Navigate to="/jaehyun-photo-shoot" replace />;
  }
